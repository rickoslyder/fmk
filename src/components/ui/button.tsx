  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 touch-target",
  {
    variants: {
      variant: {
        ...
        // FMK-specific variants
        fuck: "bg-[hsl(var(--fmk-fuck))] text-white shadow hover:bg-[hsl(var(--fmk-fuck))]/90",
        marry: "bg-[hsl(var(--fmk-marry))] text-white shadow hover:bg-[hsl(var(--fmk-marry))]/90",
        kill: "bg-[hsl(var(--fmk-kill))] text-white shadow hover:bg-[hsl(var(--fmk-kill))]/90",
      },
      size: {
        ...
        touch: "h-12 px-6 text-base min-w-touch",
        "touch-lg": "h-14 px-8 text-lg min-w-touch-lg",
      },
    },
    defaultVariants: {
      variant: "default",
